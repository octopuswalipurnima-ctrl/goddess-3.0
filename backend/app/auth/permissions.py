...
ROLE_PERMISSIONS = {
    UserRole.OWNER: {
        ...
        Permission.STREAM_ATTACH,
        Permission.STREAM_DETACH,
        Permission.STREAM_RECONNECT,
        Permission.STREAM_SAFE_MODE,
        Permission.MODERATION_READ,
        Permission.MODERATION_CONFIGURE,
        Permission.MODERATION_CONTROL,
        Permission.MODERATION_EMERGENCY,
        Permission.COHOST_READ,
        Permission.COHOST_CONFIGURE,
        Permission.COHOST_CONTROL,
